...
export const LoginAction=(email,password)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.post('https://ecommerce123-yixk.onrender.com/api/v1/login',{email,password})
...
export const RegisterAction=(userData)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.post('https://ecommerce123-yixk.onrender.com/api/v1/register',userData)
...
export const loadUser=(userData)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.get('https://ecommerce123-yixk.onrender.com/api/v1/myprofile')
...
export const logoutUser=async(dispatch)=>{
    try{
        ...
        await axios.post('https://ecommerce123-yixk.onrender.com/api/v1/logout')
...
export const updateUser=(formData)=>async(dispatch)=>{
    try{
        ...
        const user=await api.put('https://ecommerce123-yixk.onrender.com/api/v1/update',formData)
...
export const updatePasswordAction=(formData)=>async(dispatch)=>{
    try{
        ...
        const user=await api.put('https://ecommerce123-yixk.onrender.com/api/v1/password/change',formData)
        const users=user.data
...
export const forgotPasswordAction=(email)=>async(dispatch)=>{
    try{
        ...
        console.log(email)
        let user=await axios.post('https://ecommerce123-yixk.onrender.com/api/v1/password/forgot',email)
        user=user.data
        console.log(user)
...
export const resetPasswordAction=(formData,token)=>async(dispatch)=>{
    try{
        ...
        let user=await axios.post(`https://ecommerce123-yixk.onrender.com/api/v1/password/reset/${token}`,formData)
        user=user.data
