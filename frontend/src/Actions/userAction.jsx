...
export const  usersDataAction=async(dispatch)=>{
    try{
        ...
        const {data}=await axios.get(`https://ecommerce123-yixk.onrender.com/api/v1/admin/users`)
...
export const  userDataAction=id=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.get(`https://ecommerce123-yixk.onrender.com/api/v1/admin/user/${id}`)
...
export const  deleteUserDataAction=id=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.delete(`https://ecommerce123-yixk.onrender.com/api/v1/admin/user/${id}`)
...
export const  updateUserDataAction=(id,userData)=>async(dispatch)=>{
    try{
        ...
        const {data}=await api.put(`https://ecommerce123-yixk.onrender.com/api/v1/admin/user/${id}`,userData)
